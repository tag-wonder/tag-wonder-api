...
project(":unit-test") {
    dependencies {
        ...
        testImplementation(group = "com.fasterxml.jackson.core", name = "jackson-annotations", version = "2.12.4")
        testImplementation("com.fasterxml.jackson.dataformat:jackson-dataformat-cbor:2.12.4")
